...
public class KeyAndValue implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "stringValue", buffer, theStringValue, (this.stringValue!= null));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof KeyAndValue) {
            final KeyAndValue copy = ((KeyAndValue) draftCopy);
            {
            ...
            {
                Boolean stringValueShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.stringValue!= null));
                if (stringValueShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceStringValue;
                    sourceStringValue = this.getStringValue();
                    String copyStringValue = ((String) strategy.copy(LocatorUtils.property(locator, "stringValue", sourceStringValue), sourceStringValue, (this.stringValue!= null)));
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final KeyAndValue that = ((KeyAndValue) object);
        {
            String lhsKey;
            lhsKey = this.getKey();
            String rhsKey;
