    ...
    implements Cloneable, CopyTo, Equals, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Quarters) {
            ...
            if ((this.quarter!= null)&&(!this.quarter.isEmpty())) {
                List<Quarters.Quarter> sourceQuarter;
                sourceQuarter = (((this.quarter!= null)&&(!this.quarter.isEmpty()))?this.getQuarter():null);
                @SuppressWarnings("unchecked")
                List<Quarters.Quarter> copyQuarter = ((List<Quarters.Quarter> ) strategy.copy(LocatorUtils.property(locator, "quarter", sourceQuarter), sourceQuarter));
                copy.quarter = null;
                if (copyQuarter!= null) {
