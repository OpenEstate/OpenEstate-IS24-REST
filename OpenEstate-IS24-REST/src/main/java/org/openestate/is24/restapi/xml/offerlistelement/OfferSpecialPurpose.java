    ...
    implements Cloneable, CopyTo, Equals, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "specialPurposeType", buffer, theSpecialPurposeType);
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OfferSpecialPurpose) {
            ...
            if (this.specialPurposeType!= null) {
                SpecialPurposeType sourceSpecialPurposeType;
                sourceSpecialPurposeType = this.getSpecialPurposeType();
                SpecialPurposeType copySpecialPurposeType = ((SpecialPurposeType) strategy.copy(LocatorUtils.property(locator, "specialPurposeType", sourceSpecialPurposeType), sourceSpecialPurposeType));
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OfferSpecialPurpose)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "specialPurposeType", lhsSpecialPurposeType), LocatorUtils.property(thatLocator, "specialPurposeType", rhsSpecialPurposeType), lhsSpecialPurposeType, rhsSpecialPurposeType)) {
                return false;
            }
        }
        return true;
