    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        super.appendFields(locator, buffer, strategy);
        {
            ...
            strategy.appendField(locator, this, "specialPurposePropertyType", buffer, theSpecialPurposePropertyType, (this.specialPurposePropertyType!= null));
        }
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SpecialPurpose) {
            ...
            {
                Boolean specialPurposePropertyTypeShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.specialPurposePropertyType!= null));
                if (specialPurposePropertyTypeShouldBeCopiedAndSet == Boolean.TRUE) {
                    SpecialPurposeType sourceSpecialPurposePropertyType;
                    sourceSpecialPurposePropertyType = this.getSpecialPurposePropertyType();
                    SpecialPurposeType copySpecialPurposePropertyType = ((SpecialPurposeType) strategy.copy(LocatorUtils.property(locator, "specialPurposePropertyType", sourceSpecialPurposePropertyType), sourceSpecialPurposePropertyType, (this.specialPurposePropertyType!= null)));
                    copy.setSpecialPurposePropertyType(copySpecialPurposePropertyType);
                } else {
                    if (specialPurposePropertyTypeShouldBeCopiedAndSet == Boolean.FALSE) {
            ...
            }
            {
                ...
                if (basementShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    YesNotApplicableType copyBasement = ((YesNotApplicableType) strategy.copy(LocatorUtils.property(locator, "basement", sourceBasement), sourceBasement, (this.basement!= null)));
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SpecialPurpose that = ((SpecialPurpose) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "specialPurposePropertyType", lhsSpecialPurposePropertyType), LocatorUtils.property(thatLocator, "specialPurposePropertyType", rhsSpecialPurposePropertyType), lhsSpecialPurposePropertyType, rhsSpecialPurposePropertyType, (this.specialPurposePropertyType!= null), (that.specialPurposePropertyType!= null))) {
                return false;
            }
        }
        {
