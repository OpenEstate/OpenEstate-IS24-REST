 ...
 * 
 * <p>Java class for OfferIndustry complex type.
 * 
    ...
    implements Cloneable, CopyTo, Equals, ToString
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof OfferIndustry) {
            final OfferIndustry copy = ((OfferIndustry) draftCopy);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OfferIndustry)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final OfferIndustry that = ((OfferIndustry) object);
        {
