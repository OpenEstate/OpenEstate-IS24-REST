...
public class Continents implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    @XmlType(name = "")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2018-10-12T04:04:29+02:00", comments = "JAXB RI v2.2.11")
    public static class Continent implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
    {
