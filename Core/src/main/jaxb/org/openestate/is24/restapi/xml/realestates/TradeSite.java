    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "utilizationTradeSite", buffer, theUtilizationTradeSite, (this.utilizationTradeSite!= null));
        }
        {
            Long theTenancy;
        ...
        if (draftCopy instanceof TradeSite) {
            ...
            }
            {
                ...
                if (recommendedUseTypesShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    SiteRecommendedUseForTradeTypes copyRecommendedUseTypes = ((SiteRecommendedUseForTradeTypes) strategy.copy(LocatorUtils.property(locator, "recommendedUseTypes", sourceRecommendedUseTypes), sourceRecommendedUseTypes, (this.recommendedUseTypes!= null)));
            ...
            {
                Boolean utilizationTradeSiteShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.utilizationTradeSite!= null));
                if (utilizationTradeSiteShouldBeCopiedAndSet == Boolean.TRUE) {
                    UtilizationTradeSite sourceUtilizationTradeSite;
                    sourceUtilizationTradeSite = this.getUtilizationTradeSite();
                    UtilizationTradeSite copyUtilizationTradeSite = ((UtilizationTradeSite) strategy.copy(LocatorUtils.property(locator, "utilizationTradeSite", sourceUtilizationTradeSite), sourceUtilizationTradeSite, (this.utilizationTradeSite!= null)));
                    copy.setUtilizationTradeSite(copyUtilizationTradeSite);
                } else {
                    if (utilizationTradeSiteShouldBeCopiedAndSet == Boolean.FALSE) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "utilizationTradeSite", lhsUtilizationTradeSite), LocatorUtils.property(thatLocator, "utilizationTradeSite", rhsUtilizationTradeSite), lhsUtilizationTradeSite, rhsUtilizationTradeSite, (this.utilizationTradeSite!= null), (that.utilizationTradeSite!= null))) {
                return false;
            }
        }
        {
