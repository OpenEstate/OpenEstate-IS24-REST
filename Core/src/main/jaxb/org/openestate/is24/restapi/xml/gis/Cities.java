...
public class Cities implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            strategy.appendField(locator, this, "city", buffer, theCity, ((this.city!= null)&&(!this.city.isEmpty())));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof Cities) {
            ...
            {
                Boolean cityShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.city!= null)&&(!this.city.isEmpty())));
                if (cityShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    List<Cities.City> copyCity = ((List<Cities.City> ) strategy.copy(LocatorUtils.property(locator, "city", sourceCity), sourceCity, ((this.city!= null)&&(!this.city.isEmpty()))));
                    copy.city = null;
                    if (copyCity!= null) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final Cities that = ((Cities) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "city", lhsCity), LocatorUtils.property(thatLocator, "city", rhsCity), lhsCity, rhsCity, ((this.city!= null)&&(!this.city.isEmpty())), ((that.city!= null)&&(!that.city.isEmpty())))) {
                return false;
            }
        }
        return true;
