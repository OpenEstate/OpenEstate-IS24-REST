...
public class PriceRangeMandatory implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof PriceRangeMandatory) {
            final PriceRangeMandatory copy = ((PriceRangeMandatory) draftCopy);
            {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final PriceRangeMandatory that = ((PriceRangeMandatory) object);
        {
