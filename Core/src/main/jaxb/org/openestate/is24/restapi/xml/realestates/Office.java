    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    @XmlSchemaType(name = "string")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-08-07T06:36:25+02:00", comments = "JAXB RI v2.3.0")
    protected YesNotApplicableType additionalServicesIncluded;
    ...
    /**
     * Gets the value of the additionalServicesIncluded property.
     * 
     * @return
     *     possible object is
     *     {@link YesNotApplicableType }
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-08-07T06:36:25+02:00", comments = "JAXB RI v2.3.0")
    public YesNotApplicableType getAdditionalServicesIncluded() {
        return additionalServicesIncluded;
    }

    /**
     * Sets the value of the additionalServicesIncluded property.
     * 
     * @param value
     *     allowed object is
     *     {@link YesNotApplicableType }
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2021-08-07T06:36:25+02:00", comments = "JAXB RI v2.3.0")
    public void setAdditionalServicesIncluded(YesNotApplicableType value) {
        this.additionalServicesIncluded = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            YesNotApplicableType theAdditionalServicesIncluded;
            theAdditionalServicesIncluded = this.getAdditionalServicesIncluded();
            strategy.appendField(locator, this, "additionalServicesIncluded", buffer, theAdditionalServicesIncluded, (this.additionalServicesIncluded!= null));
        }
        {
        ...
        if (draftCopy instanceof Office) {
            ...
            }
            {
                ...
                if (officeRentDurationsShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    Office.OfficeRentDurations copyOfficeRentDurations = ((Office.OfficeRentDurations) strategy.copy(LocatorUtils.property(locator, "officeRentDurations", sourceOfficeRentDurations), sourceOfficeRentDurations, (this.officeRentDurations!= null)));
            ...
            {
                Boolean additionalServicesIncludedShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.additionalServicesIncluded!= null));
                if (additionalServicesIncludedShouldBeCopiedAndSet == Boolean.TRUE) {
                    YesNotApplicableType sourceAdditionalServicesIncluded;
                    sourceAdditionalServicesIncluded = this.getAdditionalServicesIncluded();
                    YesNotApplicableType copyAdditionalServicesIncluded = ((YesNotApplicableType) strategy.copy(LocatorUtils.property(locator, "additionalServicesIncluded", sourceAdditionalServicesIncluded), sourceAdditionalServicesIncluded, (this.additionalServicesIncluded!= null)));
                    copy.setAdditionalServicesIncluded(copyAdditionalServicesIncluded);
                } else {
                    if (additionalServicesIncludedShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.additionalServicesIncluded = null;
                    }
                }
            }
            {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            YesNotApplicableType lhsAdditionalServicesIncluded;
            lhsAdditionalServicesIncluded = this.getAdditionalServicesIncluded();
            YesNotApplicableType rhsAdditionalServicesIncluded;
            rhsAdditionalServicesIncluded = that.getAdditionalServicesIncluded();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "additionalServicesIncluded", lhsAdditionalServicesIncluded), LocatorUtils.property(thatLocator, "additionalServicesIncluded", rhsAdditionalServicesIncluded), lhsAdditionalServicesIncluded, rhsAdditionalServicesIncluded, (this.additionalServicesIncluded!= null), (that.additionalServicesIncluded!= null))) {
                return false;
            }
        }
        {
    ...
    public static class OfficeRentDurations implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
    {
        ...
        public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
            {
                ...
                strategy.appendField(locator, this, "officeRentDuration", buffer, theOfficeRentDuration, ((this.officeRentDuration!= null)&&(!this.officeRentDuration.isEmpty())));
            }
            return buffer;
        }
        ...
        public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
            ...
            if (draftCopy instanceof Office.OfficeRentDurations) {
                ...
                {
                    Boolean officeRentDurationShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.officeRentDuration!= null)&&(!this.officeRentDuration.isEmpty())));
                    if (officeRentDurationShouldBeCopiedAndSet == Boolean.TRUE) {
                        ...
                        List<OfficeRentDuration> copyOfficeRentDuration = ((List<OfficeRentDuration> ) strategy.copy(LocatorUtils.property(locator, "officeRentDuration", sourceOfficeRentDuration), sourceOfficeRentDuration, ((this.officeRentDuration!= null)&&(!this.officeRentDuration.isEmpty()))));
                        ...
                        if (officeRentDurationShouldBeCopiedAndSet == Boolean.FALSE) {
                            copy.officeRentDuration = null;
                        }
                    }
                }
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
            ...
            final Office.OfficeRentDurations that = ((Office.OfficeRentDurations) object);
            {
                ...
                if (!strategy.equals(LocatorUtils.property(thisLocator, "officeRentDuration", lhsOfficeRentDuration), LocatorUtils.property(thatLocator, "officeRentDuration", rhsOfficeRentDuration), lhsOfficeRentDuration, rhsOfficeRentDuration, ((this.officeRentDuration!= null)&&(!this.officeRentDuration.isEmpty())), ((that.officeRentDuration!= null)&&(!that.officeRentDuration.isEmpty())))) {
                    return false;
                }
            }
            return true;
