...
public class Wgs84AddressDescription implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof Wgs84AddressDescription) {
            final Wgs84AddressDescription copy = ((Wgs84AddressDescription) draftCopy);
            {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final Wgs84AddressDescription that = ((Wgs84AddressDescription) object);
        {
            String lhsText;
