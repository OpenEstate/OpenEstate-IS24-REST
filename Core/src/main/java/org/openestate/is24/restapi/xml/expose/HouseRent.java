 ...
 *         &lt;element name="builtInKitchen" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *         &lt;element name="assistedLiving" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            strategy.appendField(locator, this, "assistedLiving", buffer, theAssistedLiving, true);
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof HouseRent) {
            ...
            {
                Boolean assistedLivingShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, true);
                if (assistedLivingShouldBeCopiedAndSet == Boolean.TRUE) {
                    boolean sourceAssistedLiving;
                    sourceAssistedLiving = this.isAssistedLiving();
                    boolean copyAssistedLiving = strategy.copy(LocatorUtils.property(locator, "assistedLiving", sourceAssistedLiving), sourceAssistedLiving, true);
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "assistedLiving", lhsAssistedLiving), LocatorUtils.property(thatLocator, "assistedLiving", rhsAssistedLiving), lhsAssistedLiving, rhsAssistedLiving, true, true)) {
                return false;
            }
        }
        return true;
