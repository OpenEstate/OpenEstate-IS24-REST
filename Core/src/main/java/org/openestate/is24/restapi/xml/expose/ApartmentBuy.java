 ...
 *         &lt;element name="rentSubsidy" type="{http://www.w3.org/2001/XMLSchema}decimal"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    @XmlElement(required = true)
    protected BigDecimal rentSubsidy;
    ...
    /**
     * Gets the value of the rentSubsidy property.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
     *     
     */
    public BigDecimal getRentSubsidy() {
        return rentSubsidy;
    }

    /**
     * Sets the value of the rentSubsidy property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setRentSubsidy(BigDecimal value) {
        this.rentSubsidy = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            BigDecimal theRentSubsidy;
            theRentSubsidy = this.getRentSubsidy();
            strategy.appendField(locator, this, "rentSubsidy", buffer, theRentSubsidy, (this.rentSubsidy!= null));
        }
        return buffer;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ApartmentBuy) {
            ...
            {
                Boolean rentSubsidyShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.rentSubsidy!= null));
                if (rentSubsidyShouldBeCopiedAndSet == Boolean.TRUE) {
                    BigDecimal sourceRentSubsidy;
                    sourceRentSubsidy = this.getRentSubsidy();
                    BigDecimal copyRentSubsidy = ((BigDecimal) strategy.copy(LocatorUtils.property(locator, "rentSubsidy", sourceRentSubsidy), sourceRentSubsidy, (this.rentSubsidy!= null)));
                    copy.setRentSubsidy(copyRentSubsidy);
                } else {
                    if (rentSubsidyShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.rentSubsidy = null;
                    }
                }
            }
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            BigDecimal lhsRentSubsidy;
            lhsRentSubsidy = this.getRentSubsidy();
            BigDecimal rhsRentSubsidy;
            rhsRentSubsidy = that.getRentSubsidy();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "rentSubsidy", lhsRentSubsidy), LocatorUtils.property(thatLocator, "rentSubsidy", rhsRentSubsidy), lhsRentSubsidy, rhsRentSubsidy, (this.rentSubsidy!= null), (that.rentSubsidy!= null))) {
                return false;
            }
        }
        return true;
