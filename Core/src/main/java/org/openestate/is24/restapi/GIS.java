...
public class GIS {
    ...
    public final static class CityService {
         ...
         * @param is24ContinentId ID of the continent to lookup, that was returned by
         *                        {@link ContinentService}
         * @param is24CountryId   ID of the country to lookup, that was returned by
         *                        {@link CountryService}
         * @param is24RegionId    ID of the region to lookup, that was returned by
         *                        {@link RegionService}
         * @param is24CityId      ID of the city to lookup, that was returned by
         *                        {@link RegionService#getAll(org.openestate.is24.restapi.AbstractClient, long, long)}
         * @return requested city
    ...
    public final static class QuarterService {
         ...
         * @param is24CityId      ID of the city to lookup, that was returned by
         *                        {@link CityService}
         * @param is24QuarterId   ID of the quarter to lookup, that was returned by
         *                        {@link CityService#getAll(org.openestate.is24.restapi.AbstractClient, long, long, long)}
         * @return requested quarter
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         * @throws RequestFailedException if the Webservice did not respond with a success message
