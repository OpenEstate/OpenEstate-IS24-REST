...
/**
 * <p>Java class for SimpleLink complex type.
 * 
...
@XmlType(name = "SimpleLink")
public class SimpleLink implements Serializable, Cloneable, CopyTo2, Equals2, ToString2
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SimpleLink) {
            final SimpleLink copy = ((SimpleLink) draftCopy);
            {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SimpleLink that = ((SimpleLink) object);
        {
            URI lhsHref;
