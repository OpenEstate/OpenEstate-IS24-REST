...
public final class ImportExport {
    ...
    public final static class AttachmentService {
         ...
         *
         * @param client               {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalRealEstateId user defined ID of the real estate object, for which the attachment is
         *                             removed
         * @param is24AttachmentId     ID of the attachment to remove, that was returned by
         ...
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         *
         * @param client             {@link AbstractClient}, that is used to communicate with the Webservice
         * @param is24RealEstateIdId ID of the real estate object, that was returned by
         ...
         *
         * @param client               {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalRealEstateId user defined ID of the real estate object, for which the list of
         *                             attachments is retrieved
         * @return list of attachments for the requested real estate object
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         * @throws RequestFailedException if the Webservice did not respond with a success message
         ...
         * @param externalRealEstateId user defined ID of the real estate object, for which the attachment is
         *                             retrieved
         * @param is24AttachmentId     ID of the requested attachment, that was returned by
         *                             {@link AttachmentService#post(org.openestate.is24.restapi.AbstractClient, java.lang.String, org.openestate.is24.restapi.xml.common.Attachment, java.io.InputStream, java.lang.String, java.lang.String)}
         ...
         * @param externalRealEstateId user defined ID of the real estate object, for which the attachment is
         *                             retrieved
         * @param externalAttachmentId user defined ID of the attachment to retrieve
         * @return requested attachment
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         * @param externalRealEstateId user defined ID of the real estate object, for which the attachment is
         *                             stored
         * @param attachment           details about the attachment
         * @param input                {@link InputStream} with the file content of the attachment
         * @param fileName             file name of the attachment
         * @param mimeType             MIME type of the attachment
         * @return internal ID of the attachment, that was generated by the Webservice after
         * successful creation
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         * @param externalRealEstateId user defined ID of the real estate object, for which the attachment is
         *                             updated
         * @param is24AttachmentId     ID of the attachment to update, that was returned by
         *                             {@link AttachmentService#post(org.openestate.is24.restapi.AbstractClient, java.lang.String, org.openestate.is24.restapi.xml.common.Attachment, java.io.InputStream, java.lang.String, java.lang.String)}
         * @param attachment           details about the attachment
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
    ...
    public final static class AttachmentsOrderService {
         ...
         *
         * @param client               {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalRealEstateId user defined ID of the real estate object, for which the attachment
         *                             ordering is retrieved
         * @return attachment ordering for the requested real estate object
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         * @throws RequestFailedException if the Webservice did not respond with a success message
         ...
         * @param externalRealEstateId user defined ID of the real estate object, for which the attachment
         *                             ordering is changed
         * @param list                 attachment ordering to set
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
    ...
    public final static class ContactAddressService {
         ...
         *
         * @param client            {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalContactId user defined ID of the contact, for which the contact is removed
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         * @param client                    {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalContactId         user defined ID of the contact, for which the contact is removed
         * @param assignToExternalContactId user defined ID of another contact, where real estates of the removed
        ...
        public static Messages deleteByExternalId(AbstractClient client, String externalContactId, String assignToExternalContactId) throws IOException, OAuthException, JAXBException, RequestFailedException {
            ...
            if (assignToExternalContactId != null)
                params.add("assigntocontactid=" + AbstractClient.getUrlEncodedValue(assignToExternalContactId));
         ...
         *
         * @param client        {@link AbstractClient}, that is used to communicate with the Webservice
         * @param is24ContactId ID of the contact object, that was returned by
         ...
         *                              {@link ContactAddressService#post(org.openestate.is24.restapi.AbstractClient, org.openestate.is24.restapi.xml.common.RealtorContactDetails)},
         *                              for which the contact is removed
         * @param assignToIs24ContactId ID of the contact object, that was returned by
         *                              {@link ContactAddressService#post(org.openestate.is24.restapi.AbstractClient, org.openestate.is24.restapi.xml.common.RealtorContactDetails)},
         ...
         *
         * @param client            {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalContactId user defined ID of the contact, for which the contact is retrieved
         ...
         * @return internal ID of the contact person, that was generated by the Webservice
         ...
         * @param client            {@link AbstractClient}, that is used to communicate with the Webservice
         * @param contact           contact to set
         * @param externalContactId user defined ID of the contact, for which contact is updated
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
    ...
    public final static class PublishService {
         ...
         *
         * @param client        {@link AbstractClient}, that is used to communicate with the Webservice
         * @param is24PublishId the unique publishing ID, that was returned by
         ...
         *
         * @param client         {@link AbstractClient}, that is used to communicate with the Webservice
         * @param is24PublishIds list of unique publishing ID's, that were returned by
         *                       {@link PublishService#post(org.openestate.is24.restapi.AbstractClient, org.openestate.is24.restapi.xml.common.PublishObject)},
         ...
         * @param is24PublishChannelId the ID of a certain publish channel (optional, default 0)
         * @return list of publish channels, that the requested real estate object is
         * assigned to
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         *
         * @param client        {@link AbstractClient}, that is used to communicate with the Webservice
         * @param publishObject publishing to set
         * @return internal ID of the publishing, that was generated by the Webservice after
         * successful creation
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         *
         * @param client         {@link AbstractClient}, that is used to communicate with the Webservice
         * @param publishObjects publishings to set
         * @return internal ID of the publishing, that was generated by the Webservice after
         * successful creation
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
    ...
    public final static class PublishChannelService {
         ...
         *
         * @param client {@link AbstractClient}, that is used to communicate with the Webservice
         * @return list of supported publish channels
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         * @throws RequestFailedException if the Webservice did not respond with a success message
    ...
    public final static class RealEstateService {
         ...
         *
         * @param client               {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalRealEstateId user defined ID of the real estate object to remove
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         *
         * @param client           {@link AbstractClient}, that is used to communicate with the Webservice
         * @param is24RealEstateId ID of the real estate object to remove, that was returned by
         *                         {@link RealEstateService#post(org.openestate.is24.restapi.AbstractClient, org.openestate.is24.restapi.xml.realestates.RealEstate)}
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         ...
         *
         * @param client                  {@link AbstractClient}, that is used to communicate with the Webservice
         * @param inPublishChannel        the name of the publish channel to look for properties
         * @param notInPublishChannel     the name of the publish channel not to look for properties
         * @param pageSize                the number of properties per page (from min 1 until max 100, default 20)
         * @param pageNumber              the page number to return (starts with 1, default 1)
         * @param archivedObjectsIncluded include archived objects into the result
         ...
         *
         * @param client               {@link AbstractClient}, that is used to communicate with the Webservice
         * @param externalRealEstateId user defined ID of the real estate object to retrieve
         ...
         *
         * @param client           {@link AbstractClient}, that is used to communicate with the Webservice
         * @param is24RealEstateId ID of the real estate object to retrieve, that was returned by
         *                         {@link RealEstateService#post(org.openestate.is24.restapi.AbstractClient, org.openestate.is24.restapi.xml.realestates.RealEstate)}
         * @return real estate object
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         ...
         *
         * @param client     {@link AbstractClient}, that is used to communicate with the Webservice
         * @param realEstate real estate object to store
         * @return internal ID of the real estate, that was generated by the Webservice
         * after successful creation
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         * @param client                           {@link AbstractClient}, that is used to communicate with the Webservice
         * @param realEstate                       real estate object to store
         * @param useNewEnergySourceEnev2014Values tells the Webservice to make use of all values for "energySourceEnev2014"
         ...
         *
         * @param client               {@link AbstractClient}, that is used to communicate with the Webservice
         * @param realEstate           real estate object to update
         * @param externalRealEstateId user defined ID of the real estate object to update
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         ...
         * @param client           {@link AbstractClient}, that is used to communicate with the Webservice
         * @param realEstate       real estate object to update
         * @param is24RealEstateId ID of the real estate object to update, that was returned by
         *                         {@link RealEstateService#post(org.openestate.is24.restapi.AbstractClient, org.openestate.is24.restapi.xml.realestates.RealEstate)}
         * @return response of the Webservice after a successful request
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
    ...
    public final static class RealEstatesCountsService {
         ...
         *
         * @param client {@link AbstractClient}, that is used to communicate with the Webservice
         * @return summary of exported real estates
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         * @throws RequestFailedException if the Webservice did not respond with a success message
    ...
    public final static class VideoUploadService {
         ...
         *
         * @param client        {@link AbstractClient}, that is used to communicate with the Webservice
         * @param videoInput    content of the video file to transfer
         * @param videoFileName name of the video file to transfer
         * @param videoFileSize size of the video file to transfer (in bytes)
         * @return ID of the ticket, that was used to upload the video file
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         * @throws RequestFailedException if the Webservice did not respond with a success message
         ...
         *
         * @param client {@link AbstractClient}, that is used to communicate with the Webservice
         * @return created ticket for the video upload
         * @throws IOException            if communication with the Webservice failed
         * @throws OAuthException         if authorization failed
         * @throws JAXBException          if XML reading / writing failed
         * @throws RequestFailedException if the Webservice did not respond with a success message
