 ...
 */
package org.openestate.is24.restapi.hc4;
 ...
 * <a href="https://hc.apache.org/httpcomponents-client-4.5.x/">Apache HttpComponents 4.5</a>
 * for HTTP transfers.
 *
 * @author Andreas Rudolph
 * @see <a href="https://hc.apache.org/httpcomponents-client-4.5.x/">Apache HttpComponents 4.5</a>
 * @since 0.6
 */
@SuppressWarnings("WeakerAccess")
public class HttpComponents4Client extends AbstractClient {
    @SuppressWarnings("unused")
    private final static Logger LOGGER = LoggerFactory.getLogger(HttpComponents4Client.class);
    private transient HttpClient httpClient;

    /**
     * Creates an instance of {@link HttpComponents4Client}.
     *
     ...
     */
    @SuppressWarnings("unused")
    public HttpComponents4Client(String apiBaseUrl, String consumerToken, String consumerSecret) {
     ...
     */
    public HttpComponents4Client(String apiBaseUrl, String consumerToken, String consumerSecret, HttpClient httpClient) {
